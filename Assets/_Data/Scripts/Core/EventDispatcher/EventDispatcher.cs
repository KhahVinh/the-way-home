...
namespace ObserverPattern
{
    ...
    public static class EventDispatcherExtension
    {
        ...
        /// Remove event with param
        public static void RemoveListener(this MonoBehaviour listener, EventID eventID, Action<object> param)
        {
            EventDispatcher.Instance.RemoveListener(eventID, param);
        }
